"""
Django settings for CoinStackManager project.
...
SECRET_KEY = 'django-insecure-i9mct6m-@gaxtmcb5ci-^r3mgr3+c0^%69nox4r8a16#4_ee@q'
...
INSTALLED_APPS = [
    'rest_framework',
    'corsheaders',
    'coinstackcapital.apps.CoinstackcapitalConfig',
...
MIDDLEWARE = [
    ...
    'coinstackcapital.middleware.JWTAuthenticationMiddleware',
]
...
ROOT_URLCONF = 'CoinStackManager.urls'
...
WSGI_APPLICATION = 'CoinStackManager.wsgi.application'
...
AUTH_USER_MODEL = "coinstackcapital.MyUser"